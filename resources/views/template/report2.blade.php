                    ...
                    <!-- NPK Sama -->
                        @if($employeeGroup[$head]->NPK == $employees[$i]->NPK)
                            ...
                            @for($loopDays;$loopDays < (int)\Carbon\Carbon::parse($employees[$i]->TANGGAL)->format('d');$loopDays++)
                                <!-- Tidak ada absen -->
                                @if($loopDays == 5 ||  $loopDays == 6 || $loopDays == 10 ||  $loopDays == 11 || $loopDays == 12 || $loopDays == 13 || $loopDays == 19 || $loopDays == 20 || $loopDays == 26 || $loopDays == 27)
                                    <td>-<br> - <br> LBR</td>
                                @else
                            ...
                            <td><div class="mb-2">
                                ...
                                @elseif(Carbon\Carbon::parse($employees[$i]->TANGGAL)->format('d') == '10' || Carbon\Carbon::parse($employees[$i]->TANGGAL)->format('d') == '11')
                                    <div class="mb-2">
